...
from Python_Testing.server import clubs, app, get_current_date, competitions
...
def test_competition_display_based_on_date(
    client, setup_data, date_offset, expected_display
):
    """
    ...
    competitions.append({"name": test_name, "date": test_date, "numberOfPlaces": 10})
